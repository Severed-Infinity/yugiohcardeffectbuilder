...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__35680 = cljs.core.instance_QMARK_;
var expr__35681 = reactive_val;
if(cljs.core.truth_((pred__35680.cljs$core$IFn$_invoke$arity$2 ? pred__35680.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__35681) : pred__35680.call(null,reagent.ratom.RAtom,expr__35681)))){
return "ra";
} else {
if(cljs.core.truth_((pred__35680.cljs$core$IFn$_invoke$arity$2 ? pred__35680.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__35681) : pred__35680.call(null,reagent.ratom.RCursor,expr__35681)))){
return "rc";
} else {
if(cljs.core.truth_((pred__35680.cljs$core$IFn$_invoke$arity$2 ? pred__35680.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__35681) : pred__35680.call(null,reagent.ratom.Reaction,expr__35681)))){
return "rx";
} else {
if(cljs.core.truth_((pred__35680.cljs$core$IFn$_invoke$arity$2 ? pred__35680.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__35681) : pred__35680.call(null,reagent.ratom.Track,expr__35681)))){
return "tr";
} else {
return "other";
}
