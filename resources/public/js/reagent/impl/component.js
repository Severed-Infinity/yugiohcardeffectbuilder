...
if((i < len)){
var k = (ks[i]);
var G__35451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35452 = (i + (1));
m = G__35451;
i = G__35452;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35453 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__35453) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__35453));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__35455 = c;
var G__35455__$1 = (((G__35455 == null))?null:G__35455.prototype);
if((G__35455__$1 == null)){
return null;
} else {
return (G__35455__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__35457 = c;
var G__35457__$1 = (((G__35457 == null))?null:G__35457.prototype);
if((G__35457__$1 == null)){
return null;
} else {
return (G__35457__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__35461__delegate = function (args){
var G__35459 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35459) : reagent.impl.component.as_element.call(null,G__35459));
};
...
while (G__35462__i < G__35462__a.length) {G__35462__a[G__35462__i] = arguments[G__35462__i + 0]; ++G__35462__i;}
  args = new cljs.core.IndexedSeq(G__35462__a,0,null);
} 
return G__35461__delegate.call(this,args);};
G__35461.cljs$lang$maxFixedArity = 0;
G__35461.cljs$lang$applyTo = (function (arglist__35463){
var args = cljs.core.seq(arglist__35463);
return G__35461__delegate(args);
});
...
var _STAR_current_component_STAR_35465 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_35465;
}});
...
return ((function (G__35466,G__35466__$1){
...
var c = this;
var G__35467_35469 = (c["cljsRatom"]);
if((G__35467_35469 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35467_35469);
}
...
var renders_35471 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_35472 = cljs.core.first(cljs.core.vals(renders_35471));
if((cljs.core.count(renders_35471) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35471))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35472)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35472], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35470 = name;
switch (G__35470) {
case "":
...
var G__35475 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__35475) : reagent.impl.component.global$module$create_react_class.call(null,G__35475));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35476 = fiber;
var G__35476__$1 = (((G__35476 == null))?null:(G__35476["type"]));
if((G__35476__$1 == null)){
return null;
} else {
return (G__35476__$1["displayName"]);
}
})();
var parent = (function (){var G__35477 = fiber;
if((G__35477 == null)){
return null;
} else {
return (G__35477["return"]);
}
})();
var path = (function (){var G__35478 = parent;
var G__35478__$1 = (((G__35478 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35478) : reagent.impl.component.fiber_component_path.call(null,G__35478)));
if((G__35478__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35478__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__35480 = c;
if((G__35480 == null)){
return null;
} else {
return (G__35480["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__35481._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__35483 = c;
if((G__35483 == null)){
return null;
} else {
return (G__35483["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__35485 = c;
if((G__35485 == null)){
return null;
} else {
return G__35485._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__35487 = instance;
if((G__35487 == null)){
return null;
} else {
return (G__35487["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__35488 = instance;
if((G__35488 == null)){
return null;
} else {
return G__35488._currentElement;
}
}
})();
var name = (function (){var G__35489 = elem;
var G__35489__$1 = (((G__35489 == null))?null:(G__35489["type"]));
...
var owner = (function (){var or__3922__auto__ = (function (){var G__35491 = elem;
if((G__35491 == null)){
return null;
} else {
return (G__35491["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__35492._owner;
}
}
})();
var path = (function (){var G__35493 = owner;
var G__35493__$1 = (((G__35493 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35493) : reagent.impl.component.component_path.call(null,G__35493)));
if((G__35493__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35493__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35494 = c;
var G__35494__$1 = (((G__35494 == null))?null:G__35494.constructor);
if((G__35494__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35494__$1);
}
}
})();
