...
var G__35512 = o;
(G__35512[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__35513__delegate = function (args){
...
while (G__35514__i < G__35514__a.length) {G__35514__a[G__35514__i] = arguments[G__35514__i + 0]; ++G__35514__i;}
  args = new cljs.core.IndexedSeq(G__35514__a,0,null);
} 
return G__35513__delegate.call(this,args);};
G__35513.cljs$lang$maxFixedArity = 0;
G__35513.cljs$lang$applyTo = (function (arglist__35515){
var args = cljs.core.seq(arglist__35515);
return G__35513__delegate(args);
});
...
var G__35516 = o;
(G__35516[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__35521 = props;
var G__35521__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35521,cljs.core.cst$kw$id,id):G__35521);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35521__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35522){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35523__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35525){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35526__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__35526,map__35526__$1,on_write){
return (function (){
...
});})(node_value,map__35526,map__35526__$1,on_write))
);
} else {
...
var G__35529 = jsprops;
(G__35529["defaultValue"] = value);

(G__35529["onChange"] = ((function (G__35529,v,value,on_change){
return (function (p1__35528_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35528_SHARP_);
});})(G__35529,v,value,on_change))
);
...
var vec__35532 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35532,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35532,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35532,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___35536 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___35536 == null)){
} else {
var key_35537 = temp__5461__auto___35536;
(jsprops["key"] = key_35537);
}
...
var temp__5461__auto___35538 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___35538 == null)){
} else {
var key_35539 = temp__5461__auto___35538;
reagent.impl.template.oset(jsprops,"key",key_35539);
}
...
var G__35540 = reagent.impl.template.__GT_NativeWrapper();
(G__35540["name"] = c);
...
var G__35541 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35541) : reagent.impl.template.as_element.call(null,G__35541));
} else {
...
var len__4499__auto___35546 = arguments.length;
var i__4500__auto___35547 = (0);
while(true){
if((i__4500__auto___35547 < len__4499__auto___35546)){
args__4502__auto__.push((arguments[i__4500__auto___35547]));

var G__35548 = (i__4500__auto___35547 + (1));
i__4500__auto___35547 = G__35548;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35544){
var G__35545 = cljs.core.first(seq35544);
var seq35544__$1 = cljs.core.next(seq35544);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35545,seq35544__$1);
});
...
break;
default:
var G__35551 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35551;
continue;
...
var n__4376__auto___35553 = a.length;
var i_35554 = (0);
while(true){
if((i_35554 < n__4376__auto___35553)){
(a[i_35554] = reagent.impl.template.as_element((a[i_35554])));

var G__35555 = (i_35554 + (1));
i_35554 = G__35555;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___35556 = a.length;
var i_35557 = (0);
while(true){
if((i_35557 < n__4376__auto___35556)){
var val_35558 = (a[i_35557]);
if(((cljs.core.vector_QMARK_(val_35558)) && ((reagent.impl.template.key_from_vec(val_35558) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35557] = reagent.impl.template.as_element(val_35558));
...
var ctx = ({});
var vec__35560 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35560,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35560,(1),null);
...
var G__35563 = (cljs.core.count(argv) - first_child);
switch (G__35563) {
case (0):
...
case (1):
var G__35564 = comp;
var G__35565 = jsprops;
var G__35566 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__35564,G__35565,G__35566) : reagent.impl.template.global$module$react.createElement.call(null,G__35564,G__35565,G__35566));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__35563){
