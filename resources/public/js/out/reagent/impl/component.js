...
if((i < len)){
var k = (ks[i]);
var G__50033 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__50034 = (i + (1));
m = G__50033;
i = G__50034;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50036 = c;
var G__50036__$1 = (((G__50036 == null))?null:G__50036.prototype);
if((G__50036__$1 == null)){
return null;
} else {
return (G__50036__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50038 = c;
var G__50038__$1 = (((G__50038 == null))?null:G__50038.prototype);
if((G__50038__$1 == null)){
return null;
} else {
return (G__50038__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__50041__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__50041 = function (var_args){
var args = null;
...
while (G__50042__i < G__50042__a.length) {G__50042__a[G__50042__i] = arguments[G__50042__i + 0]; ++G__50042__i;}
  args = new cljs.core.IndexedSeq(G__50042__a,0,null);
} 
return G__50041__delegate.call(this,args);};
G__50041.cljs$lang$maxFixedArity = 0;
G__50041.cljs$lang$applyTo = (function (arglist__50043){
var args = cljs.core.seq(arglist__50043);
return G__50041__delegate(args);
});
G__50041.cljs$core$IFn$_invoke$arity$variadic = G__50041__delegate;
return G__50041;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_50045 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_50045;
}});
...
var G__50046 = key;
var G__50046__$1 = (((G__50046 instanceof cljs.core.Keyword))?G__50046.fqn:null);
switch (G__50046__$1) {
...
return ((function (G__50046,G__50046__$1){
...
var or__47188__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__50047_50049 = (c["cljsRatom"]);
if((G__50047_50049 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__50047_50049);
}
...
if(cljs.core.truth_((function (){var and__47176__auto__ = wrap;
...
var render_fun_50052 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_50051));
if((cljs.core.count.call(null,renders_50051) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_50051))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_50052)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_50052))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__47188__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__47188__auto__)){
return or__47188__auto__;
} else {
...
var render_fun__$1 = (function (){var or__47188__auto__ = render_fun;
if(cljs.core.truth_(or__47188__auto__)){
return or__47188__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__47188__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__47188__auto__)){
return or__47188__auto__;
} else {
...
var name__$1 = (function (){var G__50050 = name;
switch (G__50050) {
case "":
...
var G__50054 = o;
(G__50054[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__50055 = fiber;
var G__50055__$1 = (((G__50055 == null))?null:(G__50055["type"]));
if((G__50055__$1 == null)){
return null;
} else {
return (G__50055__$1["displayName"]);
}
})();
var parent = (function (){var G__50056 = fiber;
if((G__50056 == null)){
return null;
} else {
return (G__50056["return"]);
}
})();
var path = (function (){var G__50057 = parent;
var G__50057__$1 = (((G__50057 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__50057));
if((G__50057__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50057__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var G__50058 = c;
if((G__50058 == null)){
return null;
} else {
return (G__50058["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__50059 = (function (){var or__47188__auto__ = (function (){var G__50061 = c;
if((G__50061 == null)){
return null;
} else {
return (G__50061["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__47188__auto__)){
return or__47188__auto__;
...
return (G__50059["_currentElement"]);
}
})();
var name = (function (){var G__50062 = elem;
var G__50062__$1 = (((G__50062 == null))?null:(G__50062["type"]));
if((G__50062__$1 == null)){
return null;
} else {
return (G__50062__$1["displayName"]);
}
})();
var path = (function (){var G__50063 = elem;
var G__50063__$1 = (((G__50063 == null))?null:(G__50063["_owner"]));
var G__50063__$2 = (((G__50063__$1 == null))?null:reagent.impl.component.component_path.call(null,G__50063__$1));
if((G__50063__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50063__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__47188__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__47188__auto__)){
return or__47188__auto__;
} else {
var G__50064 = c;
var G__50064__$1 = (((G__50064 == null))?null:G__50064.constructor);
if((G__50064__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__50064__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1521587775338
