...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__47813__auto__,writer__47814__auto__,opt__47815__auto__){
return cljs.core._write.call(null,writer__47814__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__50077 = o;
(G__50077[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__50078__delegate = function (args){
...
while (G__50079__i < G__50079__a.length) {G__50079__a[G__50079__i] = arguments[G__50079__i + 0]; ++G__50079__i;}
  args = new cljs.core.IndexedSeq(G__50079__a,0,null);
} 
return G__50078__delegate.call(this,args);};
G__50078.cljs$lang$maxFixedArity = 0;
G__50078.cljs$lang$applyTo = (function (arglist__50080){
var args = cljs.core.seq(arglist__50080);
return G__50078__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50082){
...
var props = map__50083__$1;
var class$ = cljs.core.get.call(null,map__50083__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50085){
...
var on_write = cljs.core.get.call(null,map__50086__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__50086,map__50086__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__50086,map__50086__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__50091){
...
var synthetic_on_update = cljs.core.get.call(null,map__50092__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__50092__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__47176__auto__ = !((jsprops == null));
if(and__47176__auto__){
var and__47176__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__50094 = jsprops;
(G__50094["defaultValue"] = value);

(G__50094["onChange"] = ((function (G__50094,v,value,on_change,on_change__$1,map__50092,map__50092__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__50088_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__50088_SHARP_);
});})(G__50094,v,value,on_change,on_change__$1,map__50092,map__50092__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__50098 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__50098,(0),null);
var id = cljs.core.nth.call(null,vec__50098,(1),null);
var class$ = cljs.core.nth.call(null,vec__50098,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___50102 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___50102 == null)){
} else {
var key_50103 = temp__4661__auto___50102;
(jsprops["key"] = key_50103);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__50106){
var map__50107 = p__50106;
var map__50107__$1 = ((((!((map__50107 == null)))?((((map__50107.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50107.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50107):map__50107);
var synthetic_input = cljs.core.get.call(null,map__50107__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__50109 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__50109["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__50110 = wrapped;
(G__50110["syntheticInput"] = true);

return G__50110;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__50111 = wrapped__$1;
(G__50111["syntheticOnChange"] = on_change);

return G__50111;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__50112 = wrapped__$2;
(G__50112["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__47188__auto__ = synthetic_input;
...
var len__48359__auto___50118 = arguments.length;
var i__48360__auto___50119 = (0);
while(true){
if((i__48360__auto___50119 < len__48359__auto___50118)){
args__48366__auto__.push((arguments[i__48360__auto___50119]));

var G__50120 = (i__48360__auto___50119 + (1));
i__48360__auto___50119 = G__50120;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__48367__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50116){
var G__50117 = cljs.core.first.call(null,seq50116);
var seq50116__$1 = cljs.core.next.call(null,seq50116);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__50117,seq50116__$1);
});
...
break;
default:
var G__50123 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__50123;
continue;
...
var n__48135__auto___50125 = a.length;
var i_50126 = (0);
while(true){
if((i_50126 < n__48135__auto___50125)){
(a[i_50126] = reagent.impl.template.as_element.call(null,(a[i_50126])));

var G__50127 = (i_50126 + (1));
i_50126 = G__50127;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__48135__auto___50128 = a.length;
var i_50129 = (0);
while(true){
if((i_50129 < n__48135__auto___50128)){
var val_50130 = (a[i_50129]);
if((cljs.core.vector_QMARK_.call(null,val_50130)) && ((reagent.impl.template.key_from_vec.call(null,val_50130) == null))){
(o["no-key"] = true);
} else {
}

(a[i_50129] = reagent.impl.template.as_element.call(null,val_50130));

var G__50131 = (i_50129 + (1));
i_50129 = G__50131;
continue;
} else {
}
...
var ctx = ({});
var vec__50132 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__50132,(0),null);
var derefed = cljs.core.nth.call(null,vec__50132,(1),null);
...
var G__50135 = (cljs.core.count.call(null,argv) - first_child);
switch (G__50135) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__50135){
...
//# sourceMappingURL=template.js.map?rel=1521587775576
