...
var G__43262 = o;
(G__43262[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__43266 = o;
(G__43266[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__43267__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__43267__delegate.call(this,args);};
...
return G__43267__delegate(args);
});
...
var G__43271 = props;
var G__43271__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__43271,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43271);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__43271__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__43272){
...
var props = map__43273__$1;
var class$ = cljs.core.get.call(null,map__43273__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__43273,map__43273__$1,props,class$){
return (function (c){
...
});})(map__43273,map__43273__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__43275){
...
var on_write = cljs.core.get.call(null,map__43276__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__43276,map__43276__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__43276,map__43276__$1,on_write))
);
} else {
...
var G__43279 = jsprops;
(G__43279["defaultValue"] = value);

(G__43279["onChange"] = ((function (G__43279,v,value,on_change){
return (function (p1__43278_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__43278_SHARP_);
});})(G__43279,v,value,on_change))
);
...
var vec__43282 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__43282,(0),null);
var id = cljs.core.nth.call(null,vec__43282,(1),null);
var class$ = cljs.core.nth.call(null,vec__43282,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___43286 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___43286 == null)){
} else {
var key_43287 = temp__5461__auto___43286;
(jsprops["key"] = key_43287);
}
...
var temp__5461__auto___43288 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___43288 == null)){
} else {
var key_43289 = temp__5461__auto___43288;
reagent.impl.template.oset.call(null,jsprops,"key",key_43289);
}
...
var G__43290 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__43290["name"] = c);
...
var len__4499__auto___43295 = arguments.length;
var i__4500__auto___43296 = (0);
while(true){
if((i__4500__auto___43296 < len__4499__auto___43295)){
args__4502__auto__.push((arguments[i__4500__auto___43296]));

var G__43297 = (i__4500__auto___43296 + (1));
i__4500__auto___43296 = G__43297;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43293){
var G__43294 = cljs.core.first.call(null,seq43293);
var seq43293__$1 = cljs.core.next.call(null,seq43293);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43294,seq43293__$1);
});
...
break;
default:
var G__43300 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__43300;
continue;
...
var n__4376__auto___43302 = a.length;
var i_43303 = (0);
while(true){
if((i_43303 < n__4376__auto___43302)){
(a[i_43303] = reagent.impl.template.as_element.call(null,(a[i_43303])));

var G__43304 = (i_43303 + (1));
i_43303 = G__43304;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___43305 = a.length;
var i_43306 = (0);
while(true){
if((i_43306 < n__4376__auto___43305)){
var val_43307 = (a[i_43306]);
if(((cljs.core.vector_QMARK_.call(null,val_43307)) && ((reagent.impl.template.key_from_vec.call(null,val_43307) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_43306] = reagent.impl.template.as_element.call(null,val_43307));

var G__43308 = (i_43306 + (1));
i_43306 = G__43308;
continue;
} else {
}
...
var ctx = ({});
var vec__43309 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__43309,(0),null);
var derefed = cljs.core.nth.call(null,vec__43309,(1),null);
...
var G__43312 = (cljs.core.count.call(null,argv) - first_child);
switch (G__43312) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__43312){
...
//# sourceMappingURL=template.js.map?rel=1526415183666
