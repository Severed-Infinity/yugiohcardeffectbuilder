...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__46684 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46684,ch);
...
if(("\\" === ch__$1)){
var ch_46685__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_46685__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_46685__$2);
} else {
}

var G__46686 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__46686;
continue;
}
}
...
var vec__46694 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46694,(0),null);
var start_column = cljs.core.nth.call(null,vec__46694,(1),null);
...
var G__46697 = cljs.core.conj_BANG_.call(null,a,form);
a = G__46697;
continue;
}
}
...
var _STAR_read_delim_STAR_46698 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_46698;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__46699 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46699,(0),null);
var start_column = cljs.core.nth.call(null,vec__46699,(1),null);
...
var vec__46702 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46702,(0),null);
var end_column = cljs.core.nth.call(null,vec__46702,(1),null);
...
var vec__46705 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46705,(0),null);
var start_column = cljs.core.nth.call(null,vec__46705,(1),null);
...
var vec__46708 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46708,(0),null);
var end_column = cljs.core.nth.call(null,vec__46708,(1),null);
...
var vec__46711 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46711,(0),null);
var start_column = cljs.core.nth.call(null,vec__46711,(1),null);
...
var vec__46714 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46714,(0),null);
var end_column = cljs.core.nth.call(null,vec__46714,(1),null);
...
var sb = (function (){var G__46717 = (new goog.string.StringBuffer());
G__46717.append(initch);
...
var G__46719 = (function (){var G__46718 = sb;
G__46718.append(ch);

return G__46718;
})();
var G__46720 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46719;
ch = G__46720;
continue;
}
...
switch (G__46723) {
case "\\":
var G__46727 = (function (){var G__46724 = sb;
G__46724.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__46724;
})();
var G__46728 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46727;
ch = G__46728;
continue;
...
break;
default:
var G__46729 = (function (){var G__46725 = sb;
G__46725.append(ch);

return G__46725;
})();
var G__46730 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46729;
ch = G__46730;
continue;
...
var vec__46731 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46731,(0),null);
var end_column = cljs.core.nth.call(null,vec__46731,(1),null);
...
var vec__46734 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46734,(0),null);
var column = cljs.core.nth.call(null,vec__46734,(1),null);
...
var vec__46739 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46739,(0),null);
var column = cljs.core.nth.call(null,vec__46739,(1),null);
...
var vec__46744 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46744,(0),null);
var column = cljs.core.nth.call(null,vec__46744,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__46749 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46749,(0),null);
var start_column = cljs.core.nth.call(null,vec__46749,(1),null);
...
var vec__46752 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46752,(0),null);
var end_column = cljs.core.nth.call(null,vec__46752,(1),null);
...
var G__46755 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__46755,true,null,opts,pending_forms);
...
var G__46756 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__46756)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__46756)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__46756)){
...
var _STAR_suppress_read_STAR_46757 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46757;
}});
...
var G__46758 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__46758,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__46758,rdr,first_line);
...
var G__46762 = matched;
var G__46763 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__46762;
finished = G__46763;
continue;
} else {
...
var _STAR_suppress_read_STAR_46764 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46764;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env46765 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__46766 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46766,"(");
...
var G__46767 = (i + (1));
var G__46768 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env46765;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__46769 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__46769);
...
var G__46770 = cljs.core.next.call(null,s__$1);
var G__46771 = ret;
s__$1 = G__46770;
r = G__46771;
continue;
...
var G__46772 = cljs.core.next.call(null,s);
var G__46773 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__46772;
key_vals = G__46773;
continue;
} else {
...
var gensym_env46777 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env46777;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__46778 = token;
var G__46778__$1 = (((G__46778 == null))?null:cljs.core.subs.call(null,G__46778,(1)));
var G__46778__$2 = (((G__46778__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46778__$1));
var G__46778__$3 = (((G__46778__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46778__$2));
var G__46778__$4 = (((G__46778__$3 == null))?null:cljs.core.symbol.call(null,G__46778__$3));
if((G__46778__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__46778__$4);
}
})():(function (){var G__46779 = token;
var G__46779__$1 = (((G__46779 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46779));
if((G__46779__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46779__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e46786){if((e46786 instanceof Error)){
var e = e46786;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46790,reader){
...
var opts = map__46791__$1;
var eof = cljs.core.get.call(null,map__46791__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___46799 = arguments.length;
var i__4500__auto___46800 = (0);
while(true){
if((i__4500__auto___46800 < len__4499__auto___46799)){
args__4502__auto__.push((arguments[i__4500__auto___46800]));

var G__46801 = (i__4500__auto___46800 + (1));
i__4500__auto___46800 = G__46801;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq46797){
var G__46798 = cljs.core.first.call(null,seq46797);
var seq46797__$1 = cljs.core.next.call(null,seq46797);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46798,seq46797__$1);
});


//# sourceMappingURL=reader.js.map?rel=1526415192898
