...
var or__47188__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj52551 = {"detail":data};
return obj52551;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__47176__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__47176__auto__)){
var and__47176__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__52558 = cljs.core._EQ_;
var expr__52559 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__52558.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__52559))){
return ((function (pred__52558,expr__52559){
return (function (p1__52552_SHARP_){
return console.warn(p1__52552_SHARP_);
});
;})(pred__52558,expr__52559))
} else {
if(cljs.core.truth_(pred__52558.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__52559))){
return ((function (pred__52558,expr__52559){
return (function (p1__52553_SHARP_){
return console.debug(p1__52553_SHARP_);
});
;})(pred__52558,expr__52559))
} else {
if(cljs.core.truth_(pred__52558.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__52559))){
return ((function (pred__52558,expr__52559){
return (function (p1__52554_SHARP_){
return console.error(p1__52554_SHARP_);
});
;})(pred__52558,expr__52559))
} else {
return ((function (pred__52558,expr__52559){
return (function (p1__52555_SHARP_){
return console.log(p1__52555_SHARP_);
});
;})(pred__52558,expr__52559))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__52562){
var map__52563 = p__52562;
var map__52563__$1 = ((((!((map__52563 == null)))?((((map__52563.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52563.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52563):map__52563);
var opts = map__52563__$1;
var eval_fn = cljs.core.get.call(null,map__52563__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__52565_SHARP_);
});})(new_def))
);
...
return (function (p__52566){
var vec__52567 = p__52566;
var ky = cljs.core.nth.call(null,vec__52567,(0),null);
var v = cljs.core.nth.call(null,vec__52567,(1),null);
...
if(cljs.core.truth_((function (){var and__47176__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__47176__auto__)){
...
}catch (e52572){if((e52572 instanceof Error)){
var e = e52572;
return not_found;
} else {
throw e52572;
...
//# sourceMappingURL=utils.js.map?rel=1521587972162
