...
return (new CustomEvent(event_name,(function (){var obj50218 = {"detail":data};
return obj50218;
})()));
} else {
...
var f = (function (){var pred__50225 = cljs.core._EQ_;
var expr__50226 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__50225.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__50226))){
return ((function (pred__50225,expr__50226){
return (function (p1__50219_SHARP_){
return console.warn(p1__50219_SHARP_);
});
;})(pred__50225,expr__50226))
} else {
if(cljs.core.truth_(pred__50225.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__50226))){
return ((function (pred__50225,expr__50226){
return (function (p1__50220_SHARP_){
return console.debug(p1__50220_SHARP_);
});
;})(pred__50225,expr__50226))
} else {
if(cljs.core.truth_(pred__50225.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__50226))){
return ((function (pred__50225,expr__50226){
return (function (p1__50221_SHARP_){
return console.error(p1__50221_SHARP_);
});
;})(pred__50225,expr__50226))
} else {
return ((function (pred__50225,expr__50226){
return (function (p1__50222_SHARP_){
return console.log(p1__50222_SHARP_);
});
;})(pred__50225,expr__50226))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__50229){
...
var opts = map__50230__$1;
var eval_fn = cljs.core.get.call(null,map__50230__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__50232_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__50234,(0),null);
var v = cljs.core.nth.call(null,vec__50234,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1526415200402
