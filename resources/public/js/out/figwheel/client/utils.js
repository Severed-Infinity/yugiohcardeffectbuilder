...
return (new CustomEvent(event_name,(function (){var obj50214 = {"detail":data};
return obj50214;
})()));
} else {
...
var f = (function (){var pred__50221 = cljs.core._EQ_;
var expr__50222 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__50221.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__50222))){
return ((function (pred__50221,expr__50222){
return (function (p1__50215_SHARP_){
return console.warn(p1__50215_SHARP_);
});
;})(pred__50221,expr__50222))
} else {
if(cljs.core.truth_(pred__50221.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__50222))){
return ((function (pred__50221,expr__50222){
return (function (p1__50216_SHARP_){
return console.debug(p1__50216_SHARP_);
});
;})(pred__50221,expr__50222))
} else {
if(cljs.core.truth_(pred__50221.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__50222))){
return ((function (pred__50221,expr__50222){
return (function (p1__50217_SHARP_){
return console.error(p1__50217_SHARP_);
});
;})(pred__50221,expr__50222))
} else {
return ((function (pred__50221,expr__50222){
return (function (p1__50218_SHARP_){
return console.log(p1__50218_SHARP_);
});
;})(pred__50221,expr__50222))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__50225){
var map__50226 = p__50225;
var map__50226__$1 = ((((!((map__50226 == null)))?(((((map__50226.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50226.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50226):map__50226);
var opts = map__50226__$1;
var eval_fn = cljs.core.get.call(null,map__50226__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__50228_SHARP_);
});})(new_def))
);
...
return (function (p__50229){
var vec__50230 = p__50229;
var ky = cljs.core.nth.call(null,vec__50230,(0),null);
var v = cljs.core.nth.call(null,vec__50230,(1),null);
...
}catch (e50235){if((e50235 instanceof Error)){
var e = e50235;
return not_found;
} else {
throw e50235;
...
//# sourceMappingURL=utils.js.map?rel=1524683841937
