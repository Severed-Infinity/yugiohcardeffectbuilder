...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__50249 = cljs.core.instance_QMARK_;
var expr__50250 = reactive_val;
if(cljs.core.truth_(pred__50249.call(null,reagent.ratom.RAtom,expr__50250))){
return "ra";
} else {
if(cljs.core.truth_(pred__50249.call(null,reagent.ratom.RCursor,expr__50250))){
return "rc";
} else {
if(cljs.core.truth_(pred__50249.call(null,reagent.ratom.Reaction,expr__50250))){
return "rx";
} else {
if(cljs.core.truth_(pred__50249.call(null,reagent.ratom.Track,expr__50250))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1521587775869
